...
async function handlePostList(url, env) {
  ...
  const items = full ? filtered : filtered.map(({ content, ...meta }) => meta);
...
// .wrangler/tmp/bundle-6vDl70/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6vDl70/middleware-loader.entry.ts
